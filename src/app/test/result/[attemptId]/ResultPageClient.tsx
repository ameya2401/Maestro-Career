                    ...
                    <div className="max-w-5xl mx-auto space-y-6">
                        <div className="rounded-3xl border border-border/20 bg-card p-8 shadow-sm">
                            ...
                            <div className="mt-10 flex flex-col sm:flex-row gap-3">
                                ...
                                <Link
                                    href="/test"
                                    className="inline-flex items-center justify-center rounded-xl bg-background border border-border/20 hover:bg-muted/50 px-6 py-3 text-sm font-medium transition-colors"
                                >
                                    Take test again
                                </Link>
                            </div>
